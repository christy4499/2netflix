  ...
  return (
    <div style={{height:'600px',backgroundImage:`url(${base_url}${movie?.backdrop_path})`,backgroundPosition:'center',backgroundSize:'cover',backgroundAttachment:'fixed'}}>
      <div className='banner-content'>
        <h1>{movie?.name}</h1>
        <button className='btn btn-danger'>play <i class="fa-solid fa-caret-down"></i></button>
        <button className='btn btn-outline-light ms-3'>more info <i class="fa-solid fa-caret-right"></i></button>
